  ...
  return (
    <section id="sobre" className="sobre">
      ...
      <p className="sobre-texto">
        A Peixaria e Empório do Vale é uma empresa familiar localizada em Curitiba – PR, que há cinco anos leva qualidade incomparável em pescados e produtos coloniais para sua mesa.
        <br />
